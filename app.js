...
const fetchCrypto = async () => {
    try {
        ...
        const list = data.map((item) => {
            const {symbol, current_price, image, high_24h, low_24h,price_change_24h } = item;
            ...
            <p class="crypto-price">24 Hour Change: <span>$${priceChange3.join('')}</span></p>
            </div>
        </div>` 
        ...
        cards.forEach((card) => {
            let newPrice = card.lastElementChild.lastElementChild.firstChild.nextSibling.textContent;
            let currentPrice2 = card.lastElementChild.firstElementChild.firstElementChild;
            let currentChange = card.lastElementChild.lastElementChild.firstElementChild;
            let priceChange = card.lastElementChild.lastElementChild.firstElementChild.textContent;
